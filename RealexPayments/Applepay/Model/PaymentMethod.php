...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    const METHOD_CODE = 'realexpayments_applepay';
     ...
     * @var string
     */
    protected $_infoBlockType = 'RealexPayments\Applepay\Block\Info';
    ...
    {
        throw new \Magento\Framework\Exception\LocalizedException(__('The accept action is not available.'));
        return $this;
    }
